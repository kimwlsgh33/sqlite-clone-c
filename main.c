...
PrepareResult prepare_statement(InputBuffer *input_buffer,
                                Statement *statement) {
  // separate buffer since `insert` keyword will be followed by data
...
// there is no error handling (nothing goes wrong yet)
...
// make REPL
// get input from user and respond correctly
